                    ...
                    <>
                      {
                        post.image_urls.map((image, index) => (
                          <Link target='_blank' to={image} key={index} className='group relative rounded-lg'>
                            <img src={image} key={index} className='w-64 aspect-video object-cover ml-1 mt-1 rounded-md' alt="" />
