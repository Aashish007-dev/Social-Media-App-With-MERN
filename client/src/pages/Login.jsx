...
const Login = () => {
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
        {/* Background image */}
        <img src={assets.bgImage} className='absolute top-0 left-0 -z-1 w-full h-full object-coverz' alt="" />
        ...
        <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
            ...
            <div>
                ...
                <p className='text-xl md:text-3xl text-indigo-800 max-w-72 md:max-w-md'>connect with global community on InstaApp.</p>
            </div>
