...
const StoryViewer = ({viewStory, setViewStory}) => {
    ...
    const renderContent = () => {
        switch (viewStory.media_type) {
            case 'image':
                return ( <img src={viewStory.media_url} alt="" className='max-h-full max-w-full object-contain'/>
                );
            case 'video':
  ...
  return (
    <div className='fixed inset-0 h-screen bg-black bg-opacity-80 z-110 flex items-center justify-center' style={{backgroundColor: viewStory.media_type === 'text' ? viewStory.background_color : '#000000'}}>
