...
const ProfileModal = ({setShowEdit}) => {
    ...
    const handleSaveProfile = async (e) => {
        ...
        try {
            ...
            const {username, bio, location, full_name, cover_photo, profile_picture} = editForm;
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/90'>
                ...
                <form className='space-y-4' onSubmit={e => toast.promise(
                    ...
                    <div className='flex flex-col items-start gap-3'> 
                        <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='absolute hidden group-hover/profile:flex top-0 left-0 right-0 bottom-0 bg-black/20 rounded-full cursor-pointer items-center justify-center'>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="cover_photo" className='block test-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/cover relative'>
                                <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt=""  className='w-80 h-40 rounded-lg bg-gradient-tor from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2'/>
                                <div className='absolute hidden group-hover/cover:flex top-0 left-0 right-0 bottom-0 bg-black/20 rounded-lg cursor-pointer items-center justify-center'>
                                    <Pencil  className='w-5 h-5 text-white'/>
                                </div>
                            </div>
                        </label>
